...
{
    public class XRStudio_PrefabRedirectForce : EditorWindow
    {
        ...
        [MenuItem("GameObject/PrefabManager/PrefabRedirectForce", false, 1)]
        static void ShowRefObject()
        {
            XRStudio_PrefabRedirectForce window = (XRStudio_PrefabRedirectForce)EditorWindow.GetWindowWithRect(typeof(XRStudio_PrefabRedirectForce), new Rect(new Vector2(400, 400), new Vector2(600, 400)), true);
            window.Show();
        }
        ...
        void OnGUI()
        {
            ...
            EditorGUILayout.HelpBox("注意： 强制指向！！！！", MessageType.Error, true);
